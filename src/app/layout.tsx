...
export const metadata: Metadata = {
  title: 'Kevin Wathen | Portfolio',
  description:
    'Check out modern and stylish portfolio of an experienced Web Developer Kevin Wathen! Built using TypeScript, Next.js 14, Framaer Motion and Tailwind CSS.',
};
